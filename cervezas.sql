...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2020 a las 01:08:11
...
(1, 'Porter', 'Maltas oscuras. Sabor y aroma penetrante y nocturno. Chocolate, azucar negro y cafe. La Porter es la cerveza tributo de beerHouse a la cultura de los primeros pubs en el puerto de Londres. Cheers.', 'images/Porter.png', 170, 22, 7, 5),
(2, 'Honey', 'Babilonia antigua. Tras la boda, el padre de la novia convida al futuro yerno con cerveza de miel a lo largo de un mes. Asi lo dicta la tradicion. Nuestra Honey Beer recoge la historia que dio origen a la luna de miel y lo celebra con notas mento-ladas ', 'images/Honey.png', 170, 22, 7.5, 1),
...
(6, 'IPA', 'La India Pale Ale es una cerveza fuerte de color Ambar con un aroma intenso floral y frutal, de lupulos seleccionados en su elaboracion. Su amargor es elevado y se encuentra en balance con el dulzor aportado por las maltas.', 'images/ipa.png', 170, 51, 5, 4);
